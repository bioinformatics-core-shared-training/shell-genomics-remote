...
> Participants should bring their laptops and plan to participate actively and log onto a VM provided by the Craik-Marshall.   
>
> Learners using these materials for self-directed study will need to set up their own AMI. Information on setting up an AMI and accessing
>  the required data is provided on the [Genomics Workshop setup page](https://www.datacarpentry.org/genomics-workshop/setup.html).
{: .prereq}
